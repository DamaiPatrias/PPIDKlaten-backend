...
<div class="card">
  <div class="card-header">
    ...
    @enderror>
      <div class="form-content">
        ...
        <form action="/struktur" method="post">
            @csrf
            <div class="form-group mb-4">
              <label class="pl-2 m-0 text-dark">Pemangku Jabatan</label>
              <input type="text" name="pemangku_jabatan" class="form-control form-custom @error('pemangku_jabatan') is-invalid @enderror" placeholder="pemangku jabatan">
              @error('pemangku_jabatan')
            ...
            <div class="form-group">
              <label class="pl-2 m-0 text-dark">Jabatan</label>
              <input type="text" name="jabatan" class="form-control form-custom @error('jabatan') is-invalid @enderror" placeholder="jabatan">
              @error('jabatan')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
  ...
  <div class="card-body" style="border-bottom: 1px solid #f4f4f4;">
    <div class="mb-3">
      <form action="/struktur" method="get">
        <div class="d-flex justify-content-between">
          <div style="width: 30%;">
            <div class="input-group">
              ...
              <input type="text" class="form-control" placeholder="Pencarian" name="struktur_search" value="{{ request('struktur_search') }}">
            </div>
          </div>
        </div>
      </form>
      ...
      <table class="table table-bordered table-striped m-0">
        <thead>
          <tr>
            ...
            <th scope="col" class="text-dark font-weight-bold">Pemangku Jabatan</th>
            <th scope="col" class="text-dark font-weight-bold">Jabatan</th>
              ...
              <td class="text-center">
                ...
                @enderror >
                  <div class="form-content" style="text-align: left !important;">
                    ...
                    <form action="/struktur/{{ $item->id }}" method="post">
                      @method('patch')
                      @csrf
                      <div class="form-group mb-4">
                        <label class="pl-2 m-0 text-dark">Pemangku Jabatan</label>
                        <input type="text" name="pemangku_jabatan" class="form-control form-custom @error('pemangku_jabatan') is-invalid @enderror" value="{{ old('pemangku_jabatan', $item->pemangku_jabatan) }}">
                        @error('pemangku_jabatan')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                      ...
                      <div class="form-group">
                        <label class="pl-2 m-0 text-dark">Jabatan</label>
                        <input type="text" name="jabatan" class="form-control form-custom @error('jabatan') is-invalid @enderror" value="{{ old('jabatan', $item->jabatan) }}">
                        @error('jabatan')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                ...
                <form action="/struktur/{{ $item->id }}" method="post" class="d-inline">
                  @method('delete')
                  @csrf
